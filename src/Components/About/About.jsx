...
import resume from "../../assets/SAURABH_PRATAP SINGH_Resume.pdf"; 
    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right" className="mobileHead">
          Hello, I am <span className="about__name">Saurabh Pratap Singh</span>
        </h1>
        <Type />
        ...
        <div className="about__contact center">
          ...
          <a
            href="mailto:Surabpratapsingh1116@gmail.com"
            target="_blank"
            rel="noreferrer"
            aria-label="mail"
            className="link link--icon"
          ...
          <a
            href="https://twitter.com/SaurabhRajputN"   
            aria-label="twitter"
            className="link link--icon"
            target="_blank"
            rel="noreferrer"
